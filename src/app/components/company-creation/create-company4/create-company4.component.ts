...
export class CreateCompany4Component implements OnInit {
  ...
  get director(): FormArray{
    return <FormArray>this.capitalization.get('director');
  }

  get shareholder(): FormArray{
    return <FormArray>this.capitalization.get('shareholder');
  }
...
if(this.editCompany){
  this.http.get(this.baseurl+'workflow/getDirector/'+this.editCompany).subscribe(res=>{
    ...
    this.capitalization = this.fb.group({
    ...
    console.log(this.capitalization);
  ...
  onSubmit(){
    if(this.capitalization.valid){
      if(this.editCompany){
      this.company.updateData(this.capitalization.value,this.editCompany);
       this.company.updateStakeholder(this.capitalization.value);
      this.router.navigateByUrl('/createCompany5');
    }
    else{
    this.company.storeData(this.capitalization.value);
    this.router.navigateByUrl('/createCompany5');
  }
  }
  else{
    console.log('invalid form');
    this.validateAllFormFields(this.capitalization);
  }
  }
